...
//WarlfwSLI_e2T7p2H   - my puplick Key
//template_p2j2trf   - my template Id
//service_itiirnk    - my Service Id
  ...
  .then(() => {
    setLoading(false);
    alert('Thank you. I will get back to you as soon as possile');
